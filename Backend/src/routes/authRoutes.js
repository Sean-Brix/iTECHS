...
const { authenticateToken, requireSuperAdmin, requireTeacher } = require('../middleware/auth');
 ...
 * @desc    Register new user (Super Admin creates Teachers, Teachers create Students)
